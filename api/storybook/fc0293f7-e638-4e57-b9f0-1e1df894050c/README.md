# Application gestion réservations - Storybook Généré

## Description
Application de gestion de réservations de salles avec calendrier, filtres, notifications et dashboard admin

## Composants générés
- [Container](./src/components/Container.jsx) (réutilisé)\n- [Button](./src/components/Button.jsx) (réutilisé)\n- [Grid](./src/components/Grid.jsx) (réutilisé)\n- [Card](./src/components/Card.jsx) (réutilisé)\n- [Table](./src/components/Table.jsx) (réutilisé)\n- [Calendar](./src/components/Calendar.jsx) (réutilisé)\n- [Modal](./src/components/Modal.jsx) (réutilisé)\n- [Input](./src/components/Input.jsx) (réutilisé)\n- [Select](./src/components/Select.jsx) (réutilisé)\n- [Badge](./src/components/Badge.jsx) (réutilisé)\n- [Notification](./src/components/Notification.jsx) (réutilisé)
